...
export const DASHBOARD_METADATA = {
    units: [
        ...
        { id: 9, title: "School Terrain Profile", subtitle: "Geography & Safety", icon: FiMapPin, emoji: '🛡️', path: "/modular/unit-9", xp: 500, color: "bg-blue-600", description: "Environmental and structural variables for school location and safety." },
    ],
    forms: [
        ...
        { id: 11, name: "School Terrain Profile", route: "/modular/unit-9", icon: FiMapPin, color: "bg-rose-100 text-rose-600", flag: "f11_location", unit: 9 },
    ]
};
